...
module.exports = {
  ...
  site: {
    ...
    description: 'Mi espacio de escritura',
    ...
    url: process.env.URL || 'https://bullrich.dev/escritura',
  ...
  author: {
    ...
    url: 'https://bullrich.dev/escritura',
    ...
    fediverse: [
      {
        ...
        url: 'https://mastodon.social/@Javyer',
      },
    ],
  },
  // ---------------------------------------------------------------------------
